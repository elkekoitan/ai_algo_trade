"""
Strategy Whisperer Data Models - Complete Version
"""
...
# Pydantic models for API - using unique names to avoid conflicts
...
# Simple API models - for compatibility
class StrategyRequest(BaseModel):
    """API request model for strategy creation"""
    description: str
    language: str = "turkish"

class StrategyResponse(BaseModel):
    """API response model for strategy creation"""
    success: bool
